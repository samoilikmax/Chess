...
namespace ChessLogic
{
    public class Board
    {
        ...
        //Заполнение доски начальным расположением фигур
        ...
        private bool IsKingBishopVKingBishop(Counting counting)
        {
            ...
            Position wBishopposition = FindPiece(Player.White, PieceType.Bishop);
            Position bBishopposition = FindPiece(Player.Black, PieceType.Bishop);
        ...
        private bool IsUmnovedKingAndRook(Position kingPos, Position rookPos)
        {
        ...
        public bool CastleRightKS(Player player)
        {
            ...
            {
                Player.White => IsUmnovedKingAndRook(new Position(7, 4), new Position(7, 7)),
                Player.Black => IsUmnovedKingAndRook(new Position(0, 4), new Position(0, 7)),
                _ => false
            };
        }
        ...
        public bool CastleRightQS(Player player)
        {
            return player switch
            {
                Player.White => IsUmnovedKingAndRook(new Position(7, 4), new Position(7, 0)),
                Player.Black => IsUmnovedKingAndRook(new Position(0, 4), new Position(0, 0)),
                _ => false
            };
        }
